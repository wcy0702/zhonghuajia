    ...
    public void userValidate(User user, String token) {
        ...
        try {
           ...
           // log.error("发送邮件失败：User:" + JSONObject.toJSONString(user) + ", Token: " + token);
            System.out.println("发送邮件失败：User:" + JSONObject.toJSONString(user) + ", Token: " + token);
        }
    }
